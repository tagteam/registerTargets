#+TITLE: PhD course: Targeted Register Analysis: Day 4
...
- Modify the analysis to work with competing risks
...
- Reports the results from the analysis conclusion sentence(s) which explain the target parameters and contain the =ltmle= estimates with 95% confidence intervals.
